...
RSpec.describe ResidentsController, type: :controller do
  ...
  let(:valid_attributes) {
    Fabricate.attributes_for :resident
  }

  let(:invalid_attributes) {
    {first_name: 5, last_name: 2, birthdate: 3}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {first_name: 'Edward', last_name: 'Steeplehands'}
      }
      ...
      it "updates the requested resident" do
        ...
        resident.reload
        expect(Resident.first.first_name).to eq('Edward')
        expect(Resident.first.last_name).to eq('Steeplehands')
      end
